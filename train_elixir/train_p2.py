...
DATA_CONFIG = Path(__file__).resolve().with_name("elixir-dataset.yaml")
PRETRAINED_WEIGHTS = V2_DIR / "yolo26s.pt"
PROJECT_DIR = V2_DIR / "runs" / "detect" / "runs_elixir"
